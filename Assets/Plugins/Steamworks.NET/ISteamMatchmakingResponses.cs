...
namespace Steamworks {
	...
	// object and crash.
	//-----------------------------------------------------------------------------
	public class ISteamMatchmakinghostListResponse {
		// Server has responded ok with updated data
		public delegate void ServerResponded(HhostListRequest hRequest, int iServer);
		// Server has failed to respond
		public delegate void ServerFailedToRespond(HhostListRequest hRequest, int iServer);
		// A list refresh you had initiated is now 100% completed
		public delegate void RefreshComplete(HhostListRequest hRequest, EMatchMakingServerResponse response);
		...
		public ISteamMatchmakinghostListResponse(ServerResponded onServerResponded, ServerFailedToRespond onServerFailedToRespond, RefreshComplete onRefreshComplete) {
		...
		~ISteamMatchmakinghostListResponse() {
		...
		private delegate void InternalServerResponded(HhostListRequest hRequest, int iServer);
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		private delegate void InternalServerFailedToRespond(HhostListRequest hRequest, int iServer);
		[UnmanagedFunctionPointer(CallingConvention.StdCall)]
		private delegate void InternalRefreshComplete(HhostListRequest hRequest, EMatchMakingServerResponse response);
		private void InternalOnServerResponded(HhostListRequest hRequest, int iServer) {
			m_ServerResponded(hRequest, iServer);
		}
		private void InternalOnServerFailedToRespond(HhostListRequest hRequest, int iServer) {
			m_ServerFailedToRespond(hRequest, iServer);
		}
		private void InternalOnRefreshComplete(HhostListRequest hRequest, EMatchMakingServerResponse response) {
			m_RefreshComplete(hRequest, response);
		}
#else
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)]
		private delegate void InternalServerResponded(IntPtr thisptr, HhostListRequest hRequest, int iServer);
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)]
		private delegate void InternalServerFailedToRespond(IntPtr thisptr, HhostListRequest hRequest, int iServer);
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)]
		private delegate void InternalRefreshComplete(IntPtr thisptr, HhostListRequest hRequest, EMatchMakingServerResponse response);
		private void InternalOnServerResponded(IntPtr thisptr, HhostListRequest hRequest, int iServer) {
			m_ServerResponded(hRequest, iServer);
		}
		private void InternalOnServerFailedToRespond(IntPtr thisptr, HhostListRequest hRequest, int iServer) {
			m_ServerFailedToRespond(hRequest, iServer);
		}
		private void InternalOnRefreshComplete(IntPtr thisptr, HhostListRequest hRequest, EMatchMakingServerResponse response) {
			m_RefreshComplete(hRequest, response);
		}
#endif
		...
		public static explicit operator System.IntPtr(ISteamMatchmakinghostListResponse that) {
