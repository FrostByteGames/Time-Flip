...
namespace Steamworks {
	...
	public static class SteamMatchmakingServers {
		...
		/// <para> Request object must be released by calling ReleaseRequest( hhostListRequest )</para>
		/// </summary>
		public static HhostListRequest RequestInternethostList(AppId_t iApp, MatchMakingKeyValuePair_t[] ppchFilters, uint nFilters, ISteamMatchmakinghostListResponse pRequestServersResponse) {
			InteropHelp.TestIfAvailableClient();
			return (HhostListRequest)NativeMethods.ISteamMatchmakingServers_RequestInternethostList(iApp, new MMKVPMarshaller(ppchFilters), nFilters, (IntPtr)pRequestServersResponse);
		}

		public static HhostListRequest RequestLANhostList(AppId_t iApp, ISteamMatchmakinghostListResponse pRequestServersResponse) {
			InteropHelp.TestIfAvailableClient();
			return (HhostListRequest)NativeMethods.ISteamMatchmakingServers_RequestLANhostList(iApp, (IntPtr)pRequestServersResponse);
		}

		public static HhostListRequest RequestFriendshostList(AppId_t iApp, MatchMakingKeyValuePair_t[] ppchFilters, uint nFilters, ISteamMatchmakinghostListResponse pRequestServersResponse) {
			InteropHelp.TestIfAvailableClient();
			return (HhostListRequest)NativeMethods.ISteamMatchmakingServers_RequestFriendshostList(iApp, new MMKVPMarshaller(ppchFilters), nFilters, (IntPtr)pRequestServersResponse);
		}

		public static HhostListRequest RequestFavoriteshostList(AppId_t iApp, MatchMakingKeyValuePair_t[] ppchFilters, uint nFilters, ISteamMatchmakinghostListResponse pRequestServersResponse) {
			InteropHelp.TestIfAvailableClient();
			return (HhostListRequest)NativeMethods.ISteamMatchmakingServers_RequestFavoriteshostList(iApp, new MMKVPMarshaller(ppchFilters), nFilters, (IntPtr)pRequestServersResponse);
		}

		public static HhostListRequest RequestHistoryhostList(AppId_t iApp, MatchMakingKeyValuePair_t[] ppchFilters, uint nFilters, ISteamMatchmakinghostListResponse pRequestServersResponse) {
			InteropHelp.TestIfAvailableClient();
			return (HhostListRequest)NativeMethods.ISteamMatchmakingServers_RequestHistoryhostList(iApp, new MMKVPMarshaller(ppchFilters), nFilters, (IntPtr)pRequestServersResponse);
		}

		public static HhostListRequest RequestSpectatorhostList(AppId_t iApp, MatchMakingKeyValuePair_t[] ppchFilters, uint nFilters, ISteamMatchmakinghostListResponse pRequestServersResponse) {
			InteropHelp.TestIfAvailableClient();
			return (HhostListRequest)NativeMethods.ISteamMatchmakingServers_RequestSpectatorhostList(iApp, new MMKVPMarshaller(ppchFilters), nFilters, (IntPtr)pRequestServersResponse);
		}
		...
		/// </summary>
		public static void ReleaseRequest(HhostListRequest hhostListRequest) {
			InteropHelp.TestIfAvailableClient();
			NativeMethods.ISteamMatchmakingServers_ReleaseRequest(hhostListRequest);
		}
		...
		/// <para> ISteamMatchmakinghostListResponse::ServerResponded() callbacks</para>
		/// </summary>
		public static gameserveritem_t GetServerDetails(HhostListRequest hRequest, int iServer) {
			InteropHelp.TestIfAvailableClient();
		...
		/// </summary>
		public static void CancelQuery(HhostListRequest hRequest) {
			InteropHelp.TestIfAvailableClient();
		...
		/// </summary>
		public static void RefreshQuery(HhostListRequest hRequest) {
			InteropHelp.TestIfAvailableClient();
		...
		/// </summary>
		public static bool IsRefreshing(HhostListRequest hRequest) {
			InteropHelp.TestIfAvailableClient();
		...
		/// </summary>
		public static int GetServerCount(HhostListRequest hRequest) {
			InteropHelp.TestIfAvailableClient();
		...
		/// </summary>
		public static void RefreshServer(HhostListRequest hRequest, int iServer) {
			InteropHelp.TestIfAvailableClient();
